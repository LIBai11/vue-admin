                                        ...
                                        <div class="toolBoxControlBox">
                                            <div class="controlBox">
                                                ...
                                                <div
                                                    ...
                                                    @mousedown="
                                                        controlBtnMouseDown($event, 'leftUp')
                                                    "
                                                ...
                                                <div
                                                    ...
                                                    v-if="sizeChange === true"
                                                    @mousedown="
                                                        controlBtnMouseDown($event, 'leftDown')
                                                    "
                                                ...
                                                <div
                                                    ...
                                                    v-if="sizeChange === true"
                                                    @mousedown="
                                                        controlBtnMouseDown($event, 'rightUp')
                                                    "
                                                ...
                                                <div
                                                    ...
                                                    v-if="sizeChange === true"
                                                    @mousedown="
                                                        controlBtnMouseDown($event, 'rightDown')
                                                    "
                                                ...
                                                <div
                                                    ...
                                                    "
                                                    @mousedown="
                                                        controlBtnMouseDown($event, 'topCenter')
                                                    "
                                                ...
                                                <div
                                                    ...
                                                    "
                                                    @mousedown="
                                                        controlBtnMouseDown($event, 'downCenter')
                                                    "
                                                ...
                                                <div
                                                    ...
                                                    "
                                                    @mousedown="
                                                        controlBtnMouseDown($event, 'leftCenter')
                                                    "
