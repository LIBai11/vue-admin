...
import { MessageHeader, WordsContent, KxPagination } from '@/components'
...
const wordsVerifyInfo = computed<IWordsRecordList>(() => store.state.wordsModule.recordList)
const verifyCounts = computed<number>(() => store.state.wordsModule.count)
onMounted(() => {
    getWords({})
})
